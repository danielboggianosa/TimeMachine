            ...
            (user:any) => {
                if(user){
                    bcrypt.compare(password, user.dataValues.password, (err,result)=>{
                        if(result)
                            res.json({msg: "autorizado", user:{nombre: user.dataValues.nombre, apellido:user.dataValues.apellido, correo: user.dataValues.correo, imagen: user.dataValues.imagen}});
                        else
